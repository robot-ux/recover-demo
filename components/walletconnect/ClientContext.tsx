...
export function ClientContextProvider({
  ...
  const connect = useCallback(
    async (pairing: any) => {
      ...
      console.log('hyl pairing: ', client.pairing)
  ...
  const value = useMemo(
    ...
    [pairings, isInitializing, accounts, chains, relayerRegion, client, session, connect, disconnect, setChains, setRelayerRegion, origin]
  );
